...
from Manage_attendance import AttendanceManager
import datetime
...
class Window(QWidget):
    def __init__(self):
        super().__init__()
        self.attendance_marker = AttendanceManager()
        self.month_yr = str(datetime.datetime.now()).split(" ")[0]
    ...
    def Mark_Attendance(self):
        self.attendance_marker.mark_attendance(self.thread.person,self.month_yr)
    ...
    def Encode(self):
        ...
        self.attendance_marker.Add_name(self.editBox.text())
        self.thread.stop()
        self.thread.start()
# Run the application
